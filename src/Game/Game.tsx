...
const CLIPS: Clip[] = [
  { id: 'panel',    top: 2,  left: 32, width: 26, height: 12,
    labelKey: 'hotspot.panel',    video: 'clip_01_panel.mp4',
    endFrame: 'end_01_panel.png',    subtitleKey: 'sub.panel',
    affordance: 'ripple', affordanceX: 50, affordanceY: 55 },
  { id: 'mirror',   top: 28, left: 76, width: 22, height: 42,
    labelKey: 'hotspot.mirror',   video: 'clip_02_mirror.mp4',
    endFrame: 'end_02_mirror.png', subtitleKey: 'sub.mirror',
    affordance: 'ripple', affordanceX: 40, affordanceY: 45 },
  { id: 'stranger', top: 22, left: 0,  width: 32, height: 76,
    labelKey: 'hotspot.stranger', video: 'clip_03_stranger.mp4',
    endFrame: 'end_03_stranger.png', subtitleKey: 'sub.stranger',
    affordance: 'ripple', affordanceX: 52, affordanceY: 28 },
  { id: 'doors',    top: 12, left: 40, width: 34, height: 62,
    labelKey: 'hotspot.doors',    video: 'clip_04_doors.mp4',
    endFrame: 'end_04_doors.png',  subtitleKey: 'sub.doors',
    affordance: 'ripple', affordanceX: 50, affordanceY: 45 },
  { id: 'phone',    top: 36, left: 26, width: 16, height: 18,
    labelKey: 'hotspot.phone',    video: 'clip_05_phone.mp4',
    endFrame: 'end_05_phone.png',   subtitleKey: 'sub.phone',
