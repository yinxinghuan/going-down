...
- 游戏：Going Down
- 类型：other
- 简述：V1「下行」—— 凌晨 2:14 你独自在夜行电梯里, 角落站着一个不动的同乘人。点 5 处 (按钮面板/镜墙/同乘者/电梯门/紧急电话), 每处一段视频 + 独白, 从暧昧滑向不对劲: 楼层往下跳过不存在的层、镜里的我们更多、他的眼睛是你的、每层同一条走廊、电话里是你自己的声音。门在最底层打开:『你一直在往这里来』。粉紫超现实, 约 40s。
...
- 平台元信息：meta.title=Going Down；cover_url=/poster.png；category=other；uuid=978cba7e-6008-4dbf-8ab9-406bcc8c159d
